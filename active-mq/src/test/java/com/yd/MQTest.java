...
import com.yd.activemq.common.activemq.AMQConsumerService;
import com.yd.activemq.common.activemq.AMQProducerService;
...
public class MQTest extends BaseJunitTest {
    ...
    public void testSendMsg() {
        producerService.sendMessage(jmsTemplate,destination, "My name is yd" + (new Random()).nextInt());
    }
