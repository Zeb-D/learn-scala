...
public class TuyaClient {
     ...
     * @param code
     */
    public TuyaClient(String clientId, String sercet, RegionEnum regionEnum, String code) {
     ...
     * @param regionEnum
     */
    public TuyaClient(String clientId, String sercet, RegionEnum regionEnum){
