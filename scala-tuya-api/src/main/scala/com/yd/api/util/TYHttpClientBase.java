...
public class TYHttpClientBase {
    protected static final Log logger = LogFactory.getLog(TYHttpClientBase.class);
    protected static volatile TYHttpClient instance;
    ...
    public static void setInstance(TYHttpClient instance) {
        instance = instance;
    }

    TYHttpClientBase(ClientConfig clientConfig) {
