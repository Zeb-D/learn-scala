...
public class TuyaHttpClient extends TuyaHttpClientBase {

    protected static final Log logger = LogFactory.getLog(TuyaHttpClient.class);

    public TuyaHttpClient() {
        super();
    }

    private TuyaHttpClient(ClientConfig clientConfig) {
        super(clientConfig);
    }

    public static TuyaHttpClient getInstance() {
        if (instance != null) {
            return instance;
        } else {
            synchronized (TuyaHttpClient.class) {
                if (instance == null) {
                    instance = new TuyaHttpClient();
                }
    ...
    public static TuyaHttpClient getInstance(ClientConfig clientConfig) {
        if (instance != null) {
            return instance;
        } else {
            synchronized (TuyaHttpClient.class) {
                if (instance == null) {
                    instance = new TuyaHttpClient(clientConfig);
                }
