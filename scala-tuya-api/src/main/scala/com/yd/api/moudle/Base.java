...
import com.yd.api.util.TuyaHttpClient;
    ...
    public String sendHttpRequest(Request request) {
        ...
        switch (method){
            case POST:{
                ...
                result = TuyaHttpClient.getInstance().doPost(sb.toString(), null,  request.getBody(), getHeader(isToken, baseInfo), charset, null);
                break;
            }
            case GET:{
                if (urlParams != null) {
                ...
                result = TuyaHttpClient.getInstance().doGet(sb.toString(), getHeader(isToken, baseInfo), charset);
                break;
            }
            case DELETE:{
                result = TuyaHttpClient.getInstance().doDelete(sb.toString(), getHeader(isToken, baseInfo), charset, null);
                break;
            }
            default:{
